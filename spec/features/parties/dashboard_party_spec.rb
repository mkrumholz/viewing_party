...
RSpec.describe 'Dashboard parties' do
  ...
  it "Displays parties the user is hosting" do
    ...
    party = user.parties.create(movie_title: "Toy Story", duration: "81", starts_at: Time.parse("2021-07-14 01:00:00 -0600"), external_movie_id: 862)
  ...
  it "Displays parties the user is invited to" do
    ...
    party = user2.parties.create!(movie_title: "Toy Story", duration: "81", starts_at: Time.parse("2021-07-14 01:00:00 -0600"), external_movie_id: 862)

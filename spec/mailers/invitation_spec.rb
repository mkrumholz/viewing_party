...
RSpec.describe InvitationMailer, type: :mailer do
  describe 'invite' do
    ...
    let(:party) { user.parties.create(movie_title: "Toy Story", duration: "81", starts_at: Time.parse('2021-07-14'), external_movie_id: 862) }
    ...
    it 'assigns @party and shows details' do
      ...
      expect(mail.body.encoded).to match('06:00am')
